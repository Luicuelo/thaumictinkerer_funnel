...
package com.nekokittygames.thaumictinkerer_funnel.client.libs;
...
public class LibClientResources {
    private static final String ASSET_NAME = "thaumictinkerer_funnel";
    /**
    ...
    public static final class Shaders {
         ...
         */
        public static final String PREFIX_SHADER = "/assets/thaumictinkerer_funnel/shaders/";
        /**
