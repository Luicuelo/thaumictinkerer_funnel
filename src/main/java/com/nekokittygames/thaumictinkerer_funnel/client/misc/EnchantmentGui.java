...
public class EnchantmentGui {
    ...
    public static ResourceLocation getEnchantmentIcon(Enchantment enchantment) {
        if(enchantment==null)
            return new ResourceLocation("thaumictinkerer_funnel", "textures/enchant_icons/unknown.png");
        ...
        try {
            ...
            if (res == null)
                iconLoc = new ResourceLocation("thaumictinkerer_funnel", "textures/enchant_icons/unknown.png");
        } catch (IOException e) {
            iconLoc = new ResourceLocation("thaumictinkerer_funnel", "textures/enchant_icons/unknown.png");
        }
