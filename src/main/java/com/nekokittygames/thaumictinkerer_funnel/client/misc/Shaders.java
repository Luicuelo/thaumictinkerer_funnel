...
package com.nekokittygames.thaumictinkerer_funnel.client.misc;

import com.nekokittygames.thaumictinkerer_funnel.thaumictinkerer_funnel;
import com.nekokittygames.thaumictinkerer_funnel.client.libs.LibClientResources;
...
public class Shaders {
    ...
    private static void loadShaders() {
        ...
        thaumictinkerer_funnel.logger.info("Looks like we can shade with the best of them!");
    ...
    private static int createProgram(String vertexFilename, String fragmentFilename) {
        ...
        if (ARBShaderObjects.glGetObjectParameteriARB(program, ARBShaderObjects.GL_OBJECT_LINK_STATUS_ARB) == GL11.GL_FALSE) {
            thaumictinkerer_funnel.logger.error(ARBShaderObjects.glGetInfoLogARB(program, ARBShaderObjects.glGetObjectParameteriARB(program, ARBShaderObjects.GL_OBJECT_INFO_LOG_LENGTH_ARB)));
            return 0;
        }
    ...
    private static int createShader(String fileName, int type) {
        ...
        try {
            ...
            if (ARBShaderObjects.glGetObjectParameteriARB(shaderId, ARBShaderObjects.GL_OBJECT_COMPILE_STATUS_ARB) == GL11.GL_FALSE) {
                thaumictinkerer_funnel.logger.error(ARBShaderObjects.glGetInfoLogARB(shaderId, ARBShaderObjects.glGetObjectParameteriARB(shaderId, ARBShaderObjects.GL_OBJECT_INFO_LOG_LENGTH_ARB)));
                return 0;
            }
            return shaderId;
            ...
            thaumictinkerer_funnel.logger.error("Error registering shader ", e);
            return 0;
        }
    }
