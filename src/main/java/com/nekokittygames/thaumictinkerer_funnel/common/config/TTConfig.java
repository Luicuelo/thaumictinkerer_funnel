package com.nekokittygames.thaumictinkerer_funnel.common.config;
...
public class TTConfig {
    ...
    @Config.LangKey("thaumictinkerer_funnel.config.talisman")
    ...
    @Config.LangKey("thaumictinkerer_funnel.config.transvector_interface.distance")
    @Config.RangeInt(min = 0)
    ...
    @Config.LangKey("thaumictinkerer_funnel.config.transvector_dislocator.distance")
    @Config.RangeInt(min = 0)
    ...
    @Config.LangKey("thaumictinkerer_funnel.config.spellbinding_cloth.uses")
    @Config.RangeInt(min = 0)
    ...
    @Config.LangKey("thaumictinkerer_funnel.config.ticon.compatibility")
